...
const TutorialComponent = () => {
  return (
    <div className="flex max-w-3xl mx-auto my-8 p-6 bg-white  shadow-xl rounded-md mt-4 ">
      {/* Left Column: Tutorial Steps */}
      <div className="w-2/3 pr-8">
        <h2 className="text-3xl font-bold mb-4 text-purple-300">How to Play Othello</h2>
